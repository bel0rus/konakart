...
<div class="body">
	<div class="body-header">
		<img style="float:right" src="<%=kkEng.getImageBase()%>/table_background_specials.gif" border="0" alt="<bean:message key="information.tile.contactus"/>" title=" <bean:message key="information.tile.contactus"/> " width="<%=kkEng.getHeadingImageWidth()%>" height="<%=kkEng.getHeadingImageHeight()%>">		
		<bean:message key="information.tile.contactus"/>
	 </div>
	<div class="body-content-div">
		Put  your Contact Us information here.
	</div>
</div>						
<div class="tile">
